        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"response_code\" : \"response_code\", \"ip_version\" : 0, \"response_message\" : \"response_message\", \"ip\" : \"ip\", \"isp\" : \"isp\", \"country_name\" : \"country_name\", \"country_code2\" : \"country_code2\", \"ip_number\" : \"\" }";
