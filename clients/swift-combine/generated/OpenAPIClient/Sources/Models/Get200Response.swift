...
public struct Get200Response: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        ipNumber = try container.decodeIfPresent(String.self, forKey: .ipNumber)
        ipVersion = try container.decodeIfPresent(Int.self, forKey: .ipVersion)
        countryName = try container.decodeIfPresent(String.self, forKey: .countryName)
        countryCode2 = try container.decodeIfPresent(String.self, forKey: .countryCode2)
