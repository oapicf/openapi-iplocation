...
final ip = ; // Object | An IPv4 or IPv6 address that you would like to lookup.
final format = ; // Object | Output format, the following formats are supported: plain xml json jsonp php csv serialized
final delimiter = ; // Object | Delimiter between proxies. Can be used only with format plain. The following types are supported: 1 for \"\\n\", 2 for \"<br>\".
