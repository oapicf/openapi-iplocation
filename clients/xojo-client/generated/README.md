...
------------ | ------------- | ------------- | -------------
*OpenAPIClient.APIs.DefaultApi* | [**RootGet**](DefaultApi.md#rootget) | **GET** / | Get geolocation of an IP address


## Documentation For Models

 - [OpenAPIClient.Models.Get200Response](Get200Response.md)
 - [OpenAPIClient.Models.Get400Response](Get400Response.md)
