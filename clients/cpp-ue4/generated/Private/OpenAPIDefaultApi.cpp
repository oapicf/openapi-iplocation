...
: Url(TEXT("https://api.iplocation.net"))
{
}
...
FHttpRequestPtr OpenAPIDefaultApi::RootGet(const RootGetRequest& Request, const FRootGetDelegate& Delegate /*= FRootGetDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIDefaultApi::OnRootGetResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIDefaultApi::OnRootGetResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FRootGetDelegate Delegate) const
{
	RootGetResponse Response;
