...
- Build date: 2026-08-15T01:59:16.592128750Z[Etc/UTC]
...
```
cargo run --example openapi_client-client RootGet
```
...
------------- | ------------- | -------------
[****](docs/default_api.md#) | **GET** / | Get geolocation of an IP address
