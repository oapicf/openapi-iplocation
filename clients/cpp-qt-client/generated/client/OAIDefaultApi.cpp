...
void OAIDefaultApi::rootGet(const QString &ip, const ::OpenAPI::OptionalParam<QString> &format, const ::OpenAPI::OptionalParam<QString> &delimiter) {
    ...
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("ip")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(ip)));
    }
    if (format.hasValue())
    {
        queryStyle = "form";
    ...
    if (delimiter.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("delimiter")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(delimiter.stringValue())));
    }
