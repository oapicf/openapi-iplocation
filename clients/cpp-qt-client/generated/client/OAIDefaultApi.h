...
public:
    ...
    */
    virtual void rootGet(const QString &ip, const ::OpenAPI::OptionalParam<QString> &format = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &delimiter = ::OpenAPI::OptionalParam<QString>());
