...
public:
    ...
    /**
    * @param[in]  ip QJsonValue [required]
    * @param[in]  format QJsonValue [optional]
    * @param[in]  delimiter QJsonValue [optional]
    */
    void rootGet(const QJsonValue &ip, const ::OpenAPI::OptionalParam<QJsonValue> &format = ::OpenAPI::OptionalParam<QJsonValue>(), const ::OpenAPI::OptionalParam<QJsonValue> &delimiter = ::OpenAPI::OptionalParam<QJsonValue>());
