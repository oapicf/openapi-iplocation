...
class Get400Response(BaseModel):
    ...
    __properties = ["response_code", "response_message"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get400Response:
        """Create an instance of Get400Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Get400Response.parse_obj(obj)

        _obj = Get400Response.parse_obj({
