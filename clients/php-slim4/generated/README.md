# php-base - PHP Slim 4 Server library for iplocation.net API
...
------------ | ------------- | ------------- | -------------
*AbstractDefaultApi* | **rootGet** | **GET** / | Get geolocation of an IP address


## Models

* OpenAPIServer\Model\Get200Response
* OpenAPIServer\Model\Get400Response
