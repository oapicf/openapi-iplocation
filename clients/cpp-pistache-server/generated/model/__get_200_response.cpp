...
org::openapitools::server::model::Int64 __get_200_response::getIpNumber() const
{
    return m_Ip_number;
}
void __get_200_response::setIpNumber(org::openapitools::server::model::Int64 const& value)
{
    m_Ip_number = value;
