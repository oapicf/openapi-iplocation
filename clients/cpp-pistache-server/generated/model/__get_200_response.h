...
public:
    ...
    /// </summary>
    org::openapitools::server::model::Int64 getIpNumber() const;
    void setIpNumber(org::openapitools::server::model::Int64 const& value);
...
protected:
    std::string m_Ip;
    bool m_IpIsSet;
    org::openapitools::server::model::Int64 m_Ip_number;
