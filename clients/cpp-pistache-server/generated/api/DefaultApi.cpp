...
void DefaultApi::root_get_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    ...
    std::optional<org::openapitools::server::model::nlohmann::json> ip;
    if(ipQuery.has_value()){
        org::openapitools::server::model::nlohmann::json valueQuery_instance;
        if(fromStringValue(ipQuery.value(), valueQuery_instance)){
            ip = valueQuery_instance;
        }
    }
    auto formatQuery = request.query().get("format");
    std::optional<org::openapitools::server::model::nlohmann::json> format;
    ...
    std::optional<org::openapitools::server::model::nlohmann::json> delimiter;
