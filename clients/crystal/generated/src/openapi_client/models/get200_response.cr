...
module OpenAPIClient
  class Get200Response
    ...
    def to_h
      ...
      hash["ip"] = _to_h(ip)
      hash["ip_number"] = _to_h(ip_number)
      hash["ip_version"] = _to_h(ip_version)
      hash["country_name"] = _to_h(country_name)
      hash["country_code2"] = _to_h(country_code2)
      hash["isp"] = _to_h(isp)
      hash["response_code"] = _to_h(response_code)
      hash["response_message"] = _to_h(response_message)
      hash.to_h
    end
