...
module OpenAPIClient
  class Get200Response
    ...
    @[JSON::Field(key: "ip_number", type: Int64?, nillable: true, emit_null: false)]
    property ip_number : Int64?
    ...
    def initialize(@ip : String?, @ip_number : Int64?, @ip_version : Int32?, @country_name : String?, @country_code2 : String?, @isp : String?, @response_code : String?, @response_message : String?)
    end
