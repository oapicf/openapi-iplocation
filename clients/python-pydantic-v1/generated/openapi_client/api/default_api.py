...
class DefaultApi:
    ...
    @validate_arguments
    def root_get(self, ip : Annotated[StrictStr, Field(..., description="An IPv4 or IPv6 address that you would like to lookup.")], format : Annotated[Optional[StrictStr], Field(description="Output format, the following formats are supported: plain xml json jsonp php csv serialized")] = None, delimiter : Annotated[Optional[StrictStr], Field(description="Delimiter between proxies. Can be used only with format plain. The following types are supported: 1 for \"\\n\", 2 for \"<br>\".")] = None, **kwargs) -> Get200Response:  # noqa: E501
    ...
    @validate_arguments
    def root_get_with_http_info(self, ip : Annotated[StrictStr, Field(..., description="An IPv4 or IPv6 address that you would like to lookup.")], format : Annotated[Optional[StrictStr], Field(description="Output format, the following formats are supported: plain xml json jsonp php csv serialized")] = None, delimiter : Annotated[Optional[StrictStr], Field(description="Delimiter between proxies. Can be used only with format plain. The following types are supported: 1 for \"\\n\", 2 for \"<br>\".")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get geolocation of an IP address  # noqa: E501
