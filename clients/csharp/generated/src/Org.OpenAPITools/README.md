...
java -jar "<path>/openapi-generator/modules/openapi-generator-cli/target/openapi-generator-cli.jar" generate `
    ...
    --git-host "github.com" `
    --git-repo-id "openapi-iplocation" `
    --git-user-id "oapicf" `
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            Get200Response model = apiResponse.Ok();
        }
...
## Api Information
- appName: iplocation.net API
- appVersion: 1.1.1-pre.0
- appDescription: OpenAPI v3 specification and a set of generated API clients for iplocation.net
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {D01773EE-B01E-457B-B6A9-A564446C37D7}
- packageName: Org.OpenAPITools
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
