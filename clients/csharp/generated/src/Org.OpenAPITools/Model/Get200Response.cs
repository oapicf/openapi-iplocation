...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Get200Response : IValidatableObject
    {
        ...
        public Get200Response(string ip = default(string), Int64 ipNumber = default(Int64), int ipVersion = default(int), string countryName = default(string), string countryCode2 = default(string), string isp = default(string), string responseCode = default(string), string responseMessage = default(string))
        {
            this.Ip = ip;
