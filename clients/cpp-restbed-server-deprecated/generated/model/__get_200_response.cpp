...
__get_200_response::~__get_200_response() = default;

std::string __get_200_response::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree __get_200_response::toPropertyTree()
{
    return toPropertyTree_internal();
}

void __get_200_response::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string __get_200_response::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void __get_200_response::fromJsonString_internal(std::string const& jsonString)
{
...
ptree __get_200_response::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
	pt.put("ip", m_Ip);
...
void __get_200_response::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
	m_Ip = pt.get("ip", "");
