...
If the library is hosted at a git repository, e.g.https://github.com/cliffano/openapi-iplocation
then install it via:

```shell
    npm install cliffano/openapi-iplocation --save
```
...
var ip = null; // {Object} An IPv4 or IPv6 address that you would like to lookup.
var opts = {
