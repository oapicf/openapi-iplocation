...
export default class DefaultApi {
    ...
    */
     ...
     * @param {Object} ip An IPv4 or IPv6 address that you would like to lookup.
     * @param {Object} opts Optional parameters
     * @param {Object} opts.format Output format, the following formats are supported: plain xml json jsonp php csv serialized
     * @param {Object} opts.delimiter Delimiter between proxies. Can be used only with format plain. The following types are supported: 1 for \"\\n\", 2 for \"<br>\".
