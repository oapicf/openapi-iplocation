...
```cpp
// Create a model
auto model = models::Get200Response();
model.setIp(/* value */);  // Set ip
model.setIpNumber(/* value */);  // Set ip_number
model.setIpVersion(/* value */);  // Set ip_version
model.setCountryName(/* value */);  // Set country_name
model.setCountryCode2(/* value */);  // Set country_code2
model.setIsp(/* value */);  // Set isp
model.setResponseCode(/* value */);  // Set response_code
model.setResponseMessage(/* value */);  // Set response_message

// Serialize to JSON
nlohmann::json json = models::Get200Response::toJson(model);
std::string jsonString = json.dump();

// Deserialize from JSON
auto parsedModel = models::Get200Response::fromJson(nlohmann::json::parse(jsonString));
```
#### models::Get400Response

```cpp
// Create a model
auto model = models::Get400Response();
model.setResponseCode(/* value */);  // Set response_code
model.setResponseMessage(/* value */);  // Set response_message

// Serialize to JSON
nlohmann::json json = models::Get400Response::toJson(model);
std::string jsonString = json.dump();

// Deserialize from JSON
auto parsedModel = models::Get400Response::fromJson(nlohmann::json::parse(jsonString));
```
...
public:
    GetResponse handleGetForDefaultClass(const GetRequest& params) override {
        ...
        // Query: params.m_delimiter (optional)

        // Implement your business logic here

        // Return success response (HTTP HTTP_RESPONSE_CODE_GET200_RESPONSE):
        models::Get200Response successResponse;
        // ... populate response ...
        return successResponse;

        // Or return error response (HTTP HTTP_RESPONSE_CODE_GET400_RESPONSE):
        // models::Get400Response errorResponse;
