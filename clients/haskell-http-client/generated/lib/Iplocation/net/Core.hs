...
module Iplocation.net.Core where
...
-- | display the config
instance P.Show netConfig where
  show c =
    T.printf
...
-- | constructs a default netConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"iplocation.net/0.1.0.0"@
--
newConfig :: IO netConfig
newConfig = do
    logCxt <- initLogContext
    return $ netConfig
        { configHost = "https://api.iplocation.net"
        , configUserAgent = "iplocation.net/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => netConfig -> auth -> netConfig
addAuthMethod config@netConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: netConfig -> IO netConfig
...
withStderrLogging :: netConfig -> IO netConfig
...
withNoLogging :: netConfig -> netConfig
...
data netRequest req contentType res accept = netRequest
  { rMethod  :: NH.Method   -- ^ Method of netRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of netRequest
  , rParams   :: Params -- ^ params of netRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (netRequest req contentType res accept) NH.Method
rMethodL f netRequest{..} = (\rMethod -> netRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (netRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f netRequest{..} = (\rUrlPath -> netRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (netRequest req contentType res accept) Params
rParamsL f netRequest{..} = (\rParams -> netRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (netRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f netRequest{..} = (\rAuthTypes -> netRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => netRequest req contentType res accept -> param -> netRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: netRequest req contentType res accept -> param -> netRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: netRequest req contentType res accept -> param -> netRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
_mkRequest :: NH.Method -- ^ Method
          ...
          -> netRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = netRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     netRequest req contentType res accept
  -> [NH.Header]
  -> netRequest req contentType res accept
...
removeHeader :: netRequest req contentType res accept -> [NH.HeaderName] -> netRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => netRequest req contentType res accept -> netRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => netRequest req contentType res accept -> netRequest req contentType res accept
...
addForm :: netRequest req contentType res accept -> WH.Form -> netRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: netRequest req contentType res accept -> NH.Part -> netRequest req contentType res accept
...
_setBodyBS :: netRequest req contentType res accept -> B.ByteString -> netRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: netRequest req contentType res accept -> BL.ByteString -> netRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => netRequest req contentType res accept -> P.Proxy authMethod -> netRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> netRequest req contentType res accept
    -> IO (netRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> netConfig
  -> IO (netRequest req contentType res accept)
_applyAuthMethods req config@(netConfig {configAuthMethods = as}) =
  foldlM go req as
  where
