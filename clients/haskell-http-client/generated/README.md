## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `iplocation.net API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the iplocation.net API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Iplocation.net                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | iplocation.net                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | netConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | netRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Iplocation.net.Client    | use the "dispatch" functions to send requests       |
| Iplocation.net.Core      | core functions, config and request types            |
| Iplocation.net.API       | construct api requests                              |
| Iplocation.net.Model     | describes api models                                |
| Iplocation.net.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Iplocation.net.ModelLens | lenses for model fields                             |
| Iplocation.net.Logging   | logging functions and utils                         |
