                    ...
                    Some(param_ip) => {
                        ...
                        match param_ip {
                            ...
                            Err(e) => return Ok(Response::builder()
                                ...
                                .body(Body::from(format!("Couldn't parse query parameter ip - doesn't match schema: {}", e)))
                ...
                let param_delimiter = match param_delimiter {
                    Some(param_delimiter) => {
                        ...
                        match param_delimiter {
                            ...
                            Err(e) => return Ok(Response::builder()
                                .status(StatusCode::BAD_REQUEST)
                                .body(Body::from(format!("Couldn't parse query parameter delimiter - doesn't match schema: {}", e)))
