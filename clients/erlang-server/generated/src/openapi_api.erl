...
request_param_info('RootGet', 'format') ->
    #{
        source => qs_val  ,
        rules => [
            not_required
...
request_param_info('RootGet', 'delimiter') ->
    #{
        source => qs_val  ,
        rules => [
            not_required
...
validate_response('RootGet', 200, Body, ValidatorState) ->
    validate_response_body('__get_200_response', '__get_200_response', Body, ValidatorState);
validate_response('RootGet', 400, Body, ValidatorState) ->
    validate_response_body('__get_400_response', '__get_400_response', Body, ValidatorState);
validate_response('RootGet', 404, Body, ValidatorState) ->
    validate_response_body('__get_400_response', '__get_400_response', Body, ValidatorState);
