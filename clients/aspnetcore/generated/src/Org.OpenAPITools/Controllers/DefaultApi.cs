...
{ 
    ...
    { 
        ...
        public virtual IActionResult RootGet([FromQuery (Name = "ip")][Required()]Object ip, [FromQuery (Name = "format")]Object format, [FromQuery (Name = "delimiter")]Object delimiter)
        {
