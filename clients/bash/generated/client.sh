...
#
# This is a Bash client for iplocation.net API.
#
# LICENSE:
# 
#
...
operation_parameters_minimum_occurrences["rootGet:::ip"]=1
operation_parameters_minimum_occurrences["rootGet:::format"]=0
operation_parameters_minimum_occurrences["rootGet:::delimiter"]=0
...
operation_parameters_maximum_occurrences["rootGet:::ip"]=0
operation_parameters_maximum_occurrences["rootGet:::format"]=0
operation_parameters_maximum_occurrences["rootGet:::delimiter"]=0

##
# The type of collection for specifying multiple values for parameter:
# - multi, csv, ssv, tsv
declare -A operation_parameters_collection_type
operation_parameters_collection_type["rootGet:::ip"]=""
operation_parameters_collection_type["rootGet:::format"]=""
operation_parameters_collection_type["rootGet:::delimiter"]=""
...
${BOLD}${WHITE}iplocation.net API command line client (API version 1.1.1-pre.0)${OFF}
...
read -r -d '' ops <<EOF
  ${CYAN}rootGet${OFF};Get geolocation of an IP address
EOF
echo "  $ops" | column -t -s ';'
    echo ""
...
echo -e "              \\t\\t\\t\\t(e.g. 'https://api.iplocation.net')"
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}iplocation.net API command line client (API version 1.1.1-pre.0)${OFF}"
    echo ""
    echo -e "License: MIT"
...
print_version() {
    echo ""
    echo -e "${BOLD}iplocation.net API command line client (API version 1.1.1-pre.0)${OFF}"
    echo ""
}
...
call_rootGet() {
    ...
    # shellcheck disable=SC2034
    local query_parameter_names=(ip format delimiter)
    local path
