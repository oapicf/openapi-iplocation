...
defmodule IplocationNetAPI.Connection do
  ...
  @doc """
  Configure a IplocationNetAPI client.

  ### Parameters

  - `options`: an optional keyword list of IplocationNetAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:iplocation_net_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - IplocationNetAPI 1.0.0 - elixir"
        )
      )
