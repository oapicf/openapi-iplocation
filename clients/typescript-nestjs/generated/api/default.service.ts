...
export class DefaultService {
     ...
     * @param {*} [rootGetOpts.config] Override http request option.
     */
    public rootGet(ip: string, format?: string, delimiter?: string, rootGetOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<Get200Response>>;
    public rootGet(ip: string, format?: string, delimiter?: string, rootGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
                ...
                return this.httpClient.get<Get200Response>(`${this.basePath}/`,
                    {
                        ...
                        ...rootGetOpts?.config,
                        headers: {...headers, ...rootGetOpts?.config?.headers},
                    }
                );
            })
        );
