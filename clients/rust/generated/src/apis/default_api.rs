...
pub enum RootGetError {
    Status400(crate::models::Get400Response),
    Status404(crate::models::Get400Response),
    UnknownValue(serde_json::Value),
}


/// Retrieve geolocation of an IP address. 
pub async fn root_get(configuration: &configuration::Configuration, ip: serde_json::Value, format: Option<serde_json::Value>, delimiter: Option<serde_json::Value>) -> Result<crate::models::Get200Response, Error<RootGetError>> {
