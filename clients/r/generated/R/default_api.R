...
DefaultApi <- R6::R6Class(
  ...
  public = list(
    ...
    RootGet = function(ip, format = NULL, delimiter = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$RootGetWithHttpInfo(ip, format, delimiter, data_file = data_file, ..., .parse = .parse)
    ...
    RootGetWithHttpInfo = function(ip, format = NULL, delimiter = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "Get200Response"),
          error = function(e) {
