...
#include "CppRestOpenAPIClient/model/Int64.h"
...
public:
    ...
    /// </summary>
    std::shared_ptr<Int64> getIpNumber() const;
    bool ipNumberIsSet() const;
    void unsetIp_number();

    void setIpNumber(const std::shared_ptr<Int64>& value);
...
protected:
    ...
    bool m_IpIsSet;
    std::shared_ptr<Int64> m_Ip_number;
