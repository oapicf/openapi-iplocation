...
pplx::task<std::shared_ptr<__get_200_response>> DefaultApi::rootGet(std::shared_ptr<AnyType> ip, boost::optional<std::shared_ptr<AnyType>> format, boost::optional<std::shared_ptr<AnyType>> delimiter) const
{

    // verify the required parameter 'ip' is set
    if (ip == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'ip' when calling DefaultApi->rootGet"));
    }
    ...
    if (delimiter && *delimiter != nullptr)
    {
    ...
    {
        std::shared_ptr<__get_200_response> localVarResult(new __get_200_response());
