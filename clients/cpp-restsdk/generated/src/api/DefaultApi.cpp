...
pplx::task<std::shared_ptr<__get_200_response>> DefaultApi::rootGet(utility::string_t ip, boost::optional<utility::string_t> format, boost::optional<utility::string_t> delimiter) const
{
