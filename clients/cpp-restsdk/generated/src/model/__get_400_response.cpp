...
std::shared_ptr<AnyType> __get_400_response::getResponseCode() const
{
    return m_Response_code;
}

void __get_400_response::setResponseCode(const std::shared_ptr<AnyType>& value)
{
...
std::shared_ptr<AnyType> __get_400_response::getResponseMessage() const
{
    return m_Response_message;
}

void __get_400_response::setResponseMessage(const std::shared_ptr<AnyType>& value)
{
