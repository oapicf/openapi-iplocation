...
bool __get_200_response::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("ip_number"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Int64> refVal_setIpNumber;
...
std::shared_ptr<Int64> __get_200_response::getIpNumber() const
{
    return m_Ip_number;
}

void __get_200_response::setIpNumber(const std::shared_ptr<Int64>& value)
{
    m_Ip_number = value;
